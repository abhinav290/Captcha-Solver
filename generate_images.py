...
def main():
    ...
    parser.add_argument('--count', help='How many captchas to generate', type=int, default=100000)
    parser.add_argument('--output-dir', help='Where to store the generated captchas', type=str, default='images_test_data/sample')
